...
export const HOST = "http://localhost:3030/graphql"
...
["Clock"]:Clock;
	...
	fType?: string | undefined | null | Variable<any, string>
};
	["InputDataSetupInput"]: {
	/** Flag indicating whether market bids are used in the model. */
	useMarketBids?: boolean | undefined | null | Variable<any, string>,
	/** Flag indicating whether reserves are used in the model. If set to false, no reserve functionalities are used. */
	useReserves?: boolean | undefined | null | Variable<any, string>,
	/** Indicates whether reserves can be realised. If set to false, no realisation occurs. */
	useReserveRealisation?: boolean | undefined | null | Variable<any, string>,
	/** Indicates if dummy variables should be used in the node balance equations. */
	useNodeDummyVariables?: boolean | undefined | null | Variable<any, string>,
	/** Indicates if dummy variables should be used in the ramp balance equations. */
	useRampDummyVariables?: boolean | undefined | null | Variable<any, string>,
	/** Indicates the length of a common start, where the parameters and variable values are equal across all scenarios. Default is 0. */
	commonTimesteps?: number | undefined | null | Variable<any, string>,
	/** Name of the common start scenario, if it is used. */
...
["LocationInput"]: {
	...
	data: Array<ValueTypes["ValueInput"]> | Variable<any, string>
};
	["NewMarket"]: {
	name: string | Variable<any, string>,
	...
	realisation: Array<ValueTypes["ValueInput"]> | Variable<any, string>,
	...
	/** Name of the process. */
	name: string | Variable<any, string>,
	/** Indicates the type of the process. Options: Unit, Transfer, Market */
	conversion: ValueTypes["Conversion"] | Variable<any, string>,
	/** Indicates if the process has to match the capacity factor time series. */
	isCfFix: boolean | Variable<any, string>,
	/** Indicates if the process is an online/offline unit. */
	isOnline: boolean | Variable<any, string>,
	/** Indicates if the process participates in reserve markets */
	isRes: boolean | Variable<any, string>,
	/** Process efficiency (total output / total input) */
	eff: number | Variable<any, string>,
	/** Minimum load of the process as a fraction of total capacity. Only for online processes */
	loadMin: number | Variable<any, string>,
	/** Maximum load of the process as a fraction of total capacity. Only for online processes */
	loadMax: number | Variable<any, string>,
	/** Cost of starting the unit, only for online processes. */
	startCost: number | Variable<any, string>,
	/** Minimum time the process has to be online after start up. */
	minOnline: number | Variable<any, string>,
	/** Maximum time the process can be online. */
	maxOnline: number | Variable<any, string>,
	/** Minimum time the process has to be offline during shut down. */
	minOffline: number | Variable<any, string>,
	/** Maximum time the process can be offline. */
	maxOffline: number | Variable<any, string>,
	/** Initial state of the online unit (0 = offline, 1 = online). */
	initialState: boolean | Variable<any, string>,
	/** If true, forces the online variable of the process to be equal in all scenarios. */
	isScenarioIndependent: boolean | Variable<any, string>,
	/** Capacity factor time series for processes with cf functionality. */
	cf: Array<ValueTypes["ValueInput"]> | Variable<any, string>,
	/** Value time series of the efficiency of processes */
	effTs: Array<ValueTypes["ValueInput"]> | Variable<any, string>
};
	["NewReserveType"]: {
	name: string | Variable<any, string>,
	rampRate: number | Variable<any, string>
};
	["NewRisk"]: {
	...
	["TimeLineStartInput"]: {
	clockChoice?: ValueTypes["Clock"] | undefined | null | Variable<any, string>,
	customStartTime?: string | undefined | null | Variable<any, string>
};
	["TimeLineUpdate"]: {
	...
	start?: ValueTypes["TimeLineStartInput"] | undefined | null | Variable<any, string>
};
	["ValueInput"]: {
	scenario?: string | undefined | null | Variable<any, string>,
	constant?: number | undefined | null | Variable<any, string>,
...
createInputDataSetup?: [{	setupUpdate: ValueTypes["InputDataSetupInput"] | Variable<any, string>},ValueTypes["ValidationErrors"]],
...
setNodeState?: [{	state?: ValueTypes["NewState"] | undefined | null | Variable<any, string>,	nodeName: string | Variable<any, string>},ValueTypes["ValidationErrors"]],
...
connectNodeInflowToTemperatureForecast?: [{	nodeName: string | Variable<any, string>,	forecastName: string | Variable<any, string>,	forecastType: string | Variable<any, string>},ValueTypes["MaybeError"]],
...
connectMarketPricesToForecast?: [{	marketName: string | Variable<any, string>,	forecastName: string | Variable<any, string>,	forecastType: string | Variable<any, string>},ValueTypes["MaybeError"]],
...
createReserveType?: [{	reserveType: ValueTypes["NewReserveType"] | Variable<any, string>},ValueTypes["ValidationErrors"]],
createInflowBlock?: [{	inflowBlock: ValueTypes["NewInflowBlock"] | Variable<any, string>},ValueTypes["ValidationErrors"]],
...
["Settings"]: AliasType<{
	priceFetcherScript?:boolean | `@${string}`,
	/** Device location. */
	location?:ValueTypes["LocationSettings"],
	/** ENTSO-E API TOKEN. */
	entsoeApiToken?:boolean | `@${string}`,
		__typename?: boolean | `@${string}`
}>;
	["State"]: AliasType<{
...
["Clock"]:Clock;
	...
	fType?: string | undefined | null
};
	["InputDataSetupInput"]: {
	/** Flag indicating whether market bids are used in the model. */
	useMarketBids?: boolean | undefined | null,
	/** Flag indicating whether reserves are used in the model. If set to false, no reserve functionalities are used. */
	useReserves?: boolean | undefined | null,
	/** Indicates whether reserves can be realised. If set to false, no realisation occurs. */
	useReserveRealisation?: boolean | undefined | null,
	/** Indicates if dummy variables should be used in the node balance equations. */
...
["LocationInput"]: {
	...
	name: string,
	node: string,
	data: Array<ResolverInputTypes["ValueInput"]>
};
	["NewMarket"]: {
	name: string,
	...
	realisation: Array<ResolverInputTypes["ValueInput"]>,
	...
	["TimeLineStartInput"]: {
	clockChoice?: ResolverInputTypes["Clock"] | undefined | null,
	customStartTime?: string | undefined | null
};
	["TimeLineUpdate"]: {
	duration?: ResolverInputTypes["DurationInput"] | undefined | null,
	step?: ResolverInputTypes["DurationInput"] | undefined | null,
	start?: ResolverInputTypes["TimeLineStartInput"] | undefined | null
};
	["ValueInput"]: {
	scenario?: string | undefined | null,
	constant?: number | undefined | null,
...
["InputData"]: AliasType<{
	...
	direction?:boolean | `@${string}`,
	realisation?:ResolverInputTypes["Value"],
	reserveType?:ResolverInputTypes["ReserveType"],
	isBid?:boolean | `@${string}`,
	isLimited?:boolean | `@${string}`,
	minBid?:boolean | `@${string}`,
...
createInputDataSetup?: [{	setupUpdate: ResolverInputTypes["InputDataSetupInput"]},ResolverInputTypes["ValidationErrors"]],
...
setNodeState?: [{	state?: ResolverInputTypes["NewState"] | undefined | null,	nodeName: string},ResolverInputTypes["ValidationErrors"]],
updateNodeState?: [{	state: ResolverInputTypes["StateUpdate"],	nodeName: string},ResolverInputTypes["ValidationErrors"]],
connectNodeInflowToTemperatureForecast?: [{	nodeName: string,	forecastName: string,	forecastType: string},ResolverInputTypes["MaybeError"]],
...
connectMarketPricesToForecast?: [{	marketName: string,	forecastName: string,	forecastType: string},ResolverInputTypes["MaybeError"]],
...
createReserveType?: [{	reserveType: ResolverInputTypes["NewReserveType"]},ResolverInputTypes["ValidationErrors"]],
createInflowBlock?: [{	inflowBlock: ResolverInputTypes["NewInflowBlock"]},ResolverInputTypes["ValidationErrors"]],
...
["LocationInput"]: {
	...
	name: string,
	node: string,
	data: Array<ModelTypes["ValueInput"]>
};
	["NewMarket"]: {
	name: string,
	...
	realisation: Array<ModelTypes["ValueInput"]>,
	reserveType?: string | undefined | null,
	isBid: boolean,
	isLimited: boolean,
	minBid: number,
	...
	["TimeLineStartInput"]: {
	clockChoice?: ModelTypes["Clock"] | undefined | null,
	customStartTime?: string | undefined | null
};
	["TimeLineUpdate"]: {
	duration?: ModelTypes["DurationInput"] | undefined | null,
	step?: ModelTypes["DurationInput"] | undefined | null,
	start?: ModelTypes["TimeLineStartInput"] | undefined | null
};
	["ValueInput"]: {
	scenario?: string | undefined | null,
	constant?: number | undefined | null,
...
["InputData"]: {
	...
	direction?: ModelTypes["MarketDirection"] | undefined | null,
	realisation: Array<ModelTypes["Value"]>,
...
["Model"]: {
	...
	/** Create or Update input data setup. */
	createInputDataSetup: ModelTypes["ValidationErrors"],
	...
	/** Create new reserve type. */
	createReserveType: ModelTypes["ValidationErrors"],
	/** Create new inflow block. */
	createInflowBlock: ModelTypes["ValidationErrors"],
...
["Scenario"]: {
	...
	/** General Hertta settings. */
["Settings"]: {
		priceFetcherScript: string,
	/** Device location. */
	location?: ModelTypes["LocationSettings"] | undefined | null,
	/** ENTSO-E API TOKEN. */
	entsoeApiToken?: string | undefined | null
};
	["State"]: {
		inMax: number,
	outMax: number,
...
["LocationInput"]: {
	...
	["NewInflowBlock"]: {
		name: string,
	node: string,
	data: Array<GraphQLTypes["ValueInput"]>
};
	["NewMarket"]: {
		name: string,
	...
	realisation: Array<GraphQLTypes["ValueInput"]>,
	reserveType?: string | undefined | null,
	isBid: boolean,
	isLimited: boolean,
	minBid: number,
	...
	["TimeLineStartInput"]: {
		clockChoice?: GraphQLTypes["Clock"] | undefined | null,
	customStartTime?: string | undefined | null
};
	["TimeLineUpdate"]: {
		duration?: GraphQLTypes["DurationInput"] | undefined | null,
	step?: GraphQLTypes["DurationInput"] | undefined | null,
	start?: GraphQLTypes["TimeLineStartInput"] | undefined | null
};
	["ValueInput"]: {
		scenario?: string | undefined | null,
	constant?: number | undefined | null,
...
["InputData"]: {
	...
	direction?: GraphQLTypes["MarketDirection"] | undefined | null,
	realisation: Array<GraphQLTypes["Value"]>,
...
["Model"]: {
	...
	/** Create or Update input data setup. */
	createInputDataSetup: GraphQLTypes["ValidationErrors"],
	/** Create new node group */
	...
	/** Create new reserve type. */
	createReserveType: GraphQLTypes["ValidationErrors"],
	/** Create new inflow block. */
	createInflowBlock: GraphQLTypes["ValidationErrors"],
	/** Create new generic constraint. */
...
type ZEUS_VARIABLES = {
	...
	["InputDataSetupInput"]: ValueTypes["InputDataSetupInput"];
	["LocationInput"]: ValueTypes["LocationInput"];
	["NewGenConstraint"]: ValueTypes["NewGenConstraint"];
	["NewInflowBlock"]: ValueTypes["NewInflowBlock"];
