...
export const AllTypesProps: Record<string,any> = {
	...
	Mutation:{
		...
		createInputDataSetup:{
			setupUpdate:"InputDataSetupInput"
		},
		createNodeGroup:{
		...
		createReserveType:{
			reserveType:"NewReserveType"
		},
		createInflowBlock:{
			inflowBlock:"NewInflowBlock"
		},
		createGenConstraint:{
...
export const ReturnTypes: Record<string,any> = {
	...
	Mutation:{
		...
		createInputDataSetup:"ValidationErrors",
		...
		createReserveType:"ValidationErrors",
		createInflowBlock:"ValidationErrors",
